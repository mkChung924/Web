...
<script type="text/javascript">
	...
	function moveJumin(){
		//alert(document.joinForm.ssn1.value);
	...
	function idCheck(){
		...
		window.open('confirmid.jsp', 'child','toolbar = yes, location = no, status = no, menubar = no,' +
				'scrollbars = no, resizable = no, width = 450, height = 220, top = 200, left=900' );
	}
...
<body>
  ...
  <table border="1" cellpadding="5" width="600">
      <tr>
         ...
         <td colspan="3"><input type="text" name="id" readonly="readonly" onclick="idCheck()"> 
      ...
      <tr>
         ...
         <td colspan="3">
              <input type="text" name="jumin1" size="6" maxlength="6"
                      style="height:23px" onkeyup="moveJumin()">
              -
